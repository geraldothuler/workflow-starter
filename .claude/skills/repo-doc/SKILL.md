...
name: repo-doc
description: >
  Gera documento PDF técnico completo para um squad ou conjunto de repos: mapa de repos,
  DER, fluxos Kafka, DFDs, API REST e métricas em um único PDF navegável.
  Ativar quando o usuário pedir "mapa técnico do squad X", "doc de onboarding", "visão geral de repos".
user-invocable: true
---

# repo-doc — Mapa Técnico de Squad

## Quando usar

- `/repo-doc <squad>` — gera mapa técnico completo de um squad
